...
const dict = {
  es: {
    ...
    'col.form.mapLabel': 'Ubicación en el mapa (opcional)',
    'col.form.mapHint': 'Toca el mapa donde está la colonia, o arrastra el marcador. Puedes dejarlo vacío y añadirlo más tarde.',
    'col.form.mapLoading': 'Cargando mapa…',
    'col.form.mapError': 'No se pudo cargar el mapa. Puedes introducir las coordenadas a mano.',
    'col.form.useMyLocation': 'Mi ubicación',
    'col.form.locating': 'Localizando…',
    'col.form.geoError': 'No se pudo obtener tu ubicación. Revisa los permisos del navegador o toca el mapa.',
    'col.form.manualToggle': 'Introducir coordenadas a mano',
  ...
  ca: {
    ...
    'col.form.latPh': 'Latitud (41.382)',
    'col.form.lngPh': 'Longitud (2.174)',
    'col.form.mapLabel': 'Ubicació al mapa (opcional)',
    'col.form.mapHint': 'Toca el mapa on és la colònia, o arrossega el marcador. Pots deixar-ho buit i afegir-ho més tard.',
    'col.form.mapLoading': 'Carregant el mapa…',
    'col.form.mapError': 'No s\'ha pogut carregar el mapa. Pots introduir les coordenades a mà.',
    'col.form.useMyLocation': 'La meva ubicació',
    'col.form.locating': 'Localitzant…',
    'col.form.geoError': 'No s\'ha pogut obtenir la teva ubicació. Revisa els permisos del navegador o toca el mapa.',
    'col.form.manualToggle': 'Introduir coordenades a mà',
